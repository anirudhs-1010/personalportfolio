...
Implemented LLM chatbot feature using Gemini API for real-time communication with user.
      ...
      <section id="contact" className="container mx-auto py-16 px-4">
        ...
        <div className="max-w-2xl mx-auto bg-gray-700 rounded-xl p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div 
              className="flex flex-col items-center p-4 bg-gray-600 rounded-lg"
              whileHover={{ scale: 1.05 }}
            >
              ...
              <a href="mailto:anirudhs1010@gmail.com" className="text-blue-400 hover:text-blue-300 transition-colors">
                anirudhs1010@gmail.com
              </a>
            </motion.div>
            ...
            >
              ...
              <a href="https://www.linkedin.com/in/anirudh-sunil-a9890720a/" className="text-blue-400 hover:text-blue-300 transition-colors">
                linkedin.com
              </a>
            </motion.div>
          </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input type="text" id="name" className="w-full p-3 bg-gray-800 rounded-lg focus:ring-2 focus:ring-blue-400 outline-none" />
              </div>
              <div>
                <label htmlFor="email" className="block mb-2 text-sm font-medium">Email</label>
                <input type="email" id="email" className="w-full p-3 bg-gray-800 rounded-lg focus:ring-2 focus:ring-blue-400 outline-none" />
              </div>
            </div>
            <div className="mb-4">
              <label htmlFor="subject" className="block mb-2 text-sm font-medium">Subject</label>
              <input type="text" id="subject" className="w-full p-3 bg-gray-800 rounded-lg focus:ring-2 focus:ring-blue-400 outline-none" />
            </div>
            <div className="mb-6">
              <label htmlFor="message" className="block mb-2 text-sm font-medium">Message</label>
              <textarea id="message" rows="4" className="w-full p-3 bg-gray-800 rounded-lg focus:ring-2 focus:ring-blue-400 outline-none"></textarea>
            </div>
            <motion.button 
              type="submit" 
              className="w-full bg-gradient-to-r from-blue-500 to-purple-600 py-3 px-6 rounded-lg text-lg font-medium hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg"
